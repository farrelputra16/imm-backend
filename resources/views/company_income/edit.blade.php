...
<div class="container">
    ...
    <form action="{{ route('company-income.update', $income->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" name="jumlah_hibah" id="jumlah_hibah" class="form-control" value="{{ old('jumlah_hibah', $income->jumlah) }}" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <select name="tipe_investasi" id="tipe_investasi" class="form-control" required>
